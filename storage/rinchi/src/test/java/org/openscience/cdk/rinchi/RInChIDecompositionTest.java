...
public class RInChIDecompositionTest extends CDKTestCase {
	...
	public void test_03() throws Exception {
		...
		Assert.assertEquals("RInChIDecomposition", RinchiDecompositionStatus.SUCCESS, rdecomp.getStatus());
		Assert.assertNotNull("Inchis: ", rdecomp.getIinchis());
		Assert.assertEquals("Number of inchis: ", 1, rdecomp.getIinchis().length);
		Assert.assertEquals("RInChI reaction direction: ", ReactionDirection.FORWARD, rdecomp.getReactionDirection());

		Assert.assertEquals("Inchi 0", "InChI=1S/C8H8O2/c9-8(10)6-7-4-2-1-3-5-7/h1-5H,6H2,(H,9,10)", rdecomp.getIinchis()[0]);
		Assert.assertEquals("Role 0", ReactionComponentRole.PRODUCT, rdecomp.getRoles()[0]);
		Assert.assertEquals("AuxInfo 0", "AuxInfo=1/1/N:3,2,4,1,5,7,6,8,9,10/E:(2,3)(4,5)(9,10)/rA:10nCCCCCCCCOO/rB:d1;s2;d3;s4;s1d5;s6;s7;s8;d8;/rC:14.2607,3.2411,0;13.5462,2.8286,0;13.5462,2.0036,0;14.2607,1.5911,0;14.9752,2.0036,0;14.9752,2.8286,0;15.6897,3.2411,0;16.4041,2.8286,0;17.1186,3.2411,0;16.4041,2.0036,0;", rdecomp.getAuxInfos()[0]);
	}
	...
	public void test_04() throws Exception {
		...
		Assert.assertEquals("RInChIDecomposition", RinchiDecompositionStatus.SUCCESS, rdecomp.getStatus());
		Assert.assertNotNull("Inchis: ", rdecomp.getIinchis());
		Assert.assertEquals("Number of inchis: ", 4, rdecomp.getIinchis().length);
		Assert.assertEquals("RInChI reaction direction: ", ReactionDirection.BACKWARD, rdecomp.getReactionDirection());

		Assert.assertEquals("Inchi 0", "InChI=1S/C4H9BrO/c1-3(5)4(2)6/h3-4,6H,1-2H3/t3-,4+/m1/s1", rdecomp.getIinchis()[0]);
		Assert.assertEquals("Role 0", ReactionComponentRole.REAGENT, rdecomp.getRoles()[0]);
		Assert.assertEquals("AuxInfo 0", "AuxInfo=1/0/N:4,1,3,2,6,5/it:im/rA:6nCCCCOBr/rB:s1;s2;s3;N2;P3;/rC:-.825,-.7557,0;-.4125,-.0412,0;.4125,-.0412,0;.825,.6733,0;-.626,.7557,0;.825,-.7557,0;", rdecomp.getAuxInfos()[0]);
		Assert.assertEquals("Inchi 1", "InChI=1S/Na.H2O/h;1H2/q+1;/p-1", rdecomp.getIinchis()[1]);
		Assert.assertEquals("Role 1", ReactionComponentRole.REAGENT, rdecomp.getRoles()[1]);
		Assert.assertEquals("AuxInfo 1", "AuxInfo=1/1/N:1;2/rA:2nNaO/rB:s1;/rC:-.4125,0,0;.4125,0,0;", rdecomp.getAuxInfos()[1]);
		Assert.assertEquals("Inchi 2", "InChI=1S/C4H8O/c1-3-4(2)5-3/h3-4H,1-2H3/t3-,4?/m0/s1", rdecomp.getIinchis()[2]);
		Assert.assertEquals("Role 2", ReactionComponentRole.PRODUCT, rdecomp.getRoles()[2]);
		Assert.assertEquals("AuxInfo 2", "AuxInfo=1/0/N:4,1,3,2,5/E:(1,2)(3,4)/it:im/rA:5nCCCCO/rB:N1;s2;P3;s2s3;/rC:-1.127,-.5635,0;-.4125,-.151,0;.4125,-.151,0;1.127,-.5635,0;0,.5635,0;", rdecomp.getAuxInfos()[2]);
		Assert.assertEquals("Inchi 3", "InChI=1S//", rdecomp.getIinchis()[3]);
		Assert.assertEquals("Role 3", ReactionComponentRole.PRODUCT, rdecomp.getRoles()[3]);
		Assert.assertEquals("AuxInfo 3", "AuxInfo=1//", rdecomp.getAuxInfos()[3]);
	}
	...
	public void test_05() throws Exception {
		...
		Assert.assertEquals("Role 1", ReactionComponentRole.REAGENT, rdecomp.getRoles()[1]);
		Assert.assertEquals("AuxInfo 1", "AuxInfo=1/1/N:1;2/rA:2nNaO/rB:s1;/rC:-.4125,0,0;.4125,0,0;", rdecomp.getAuxInfos()[1]);
		Assert.assertEquals("Inchi 2", "InChI=1S//", rdecomp.getIinchis()[2]);
		Assert.assertEquals("Role 2", ReactionComponentRole.REAGENT, rdecomp.getRoles()[2]);
		Assert.assertEquals("AuxInfo 2", "AuxInfo=1//", rdecomp.getAuxInfos()[2]);
		Assert.assertEquals("Inchi 3", "InChI=1S/C4H8O/c1-3-4(2)5-3/h3-4H,1-2H3/t3-,4?/m0/s1", rdecomp.getIinchis()[3]);
		Assert.assertEquals("Role 3", ReactionComponentRole.PRODUCT, rdecomp.getRoles()[3]);
		Assert.assertEquals("AuxInfo 3", "AuxInfo=1/0/N:4,1,3,2,5/E:(1,2)(3,4)/it:im/rA:5nCCCCO/rB:N1;s2;P3;s2s3;/rC:-1.127,-.5635,0;-.4125,-.151,0;.4125,-.151,0;1.127,-.5635,0;0,.5635,0;", rdecomp.getAuxInfos()[3]);
	}
	...
	public void test_06() throws Exception {
		...
		Assert.assertEquals("RInChIDecomposition", RinchiDecompositionStatus.SUCCESS, rdecomp.getStatus());
		Assert.assertNotNull("Inchis: ", rdecomp.getIinchis());
		Assert.assertEquals("Number of inchis: ", 5, rdecomp.getIinchis().length);
		Assert.assertEquals("RInChI reaction direction: ", ReactionDirection.BACKWARD, rdecomp.getReactionDirection());

		Assert.assertEquals("Inchi 0", "InChI=1S/C4H9BrO/c1-3(5)4(2)6/h3-4,6H,1-2H3/t3-,4+/m1/s1", rdecomp.getIinchis()[0]);
		Assert.assertEquals("Role 0", ReactionComponentRole.REAGENT, rdecomp.getRoles()[0]);
		Assert.assertEquals("AuxInfo 0", "", rdecomp.getAuxInfos()[0]);
		Assert.assertEquals("Inchi 1", "InChI=1S/Na.H2O/h;1H2/q+1;/p-1", rdecomp.getIinchis()[1]);
		Assert.assertEquals("Role 1", ReactionComponentRole.REAGENT, rdecomp.getRoles()[1]);
		Assert.assertEquals("AuxInfo 1", "", rdecomp.getAuxInfos()[1]);
		Assert.assertEquals("Inchi 2", "InChI=1S//", rdecomp.getIinchis()[2]);
		Assert.assertEquals("Role 2", ReactionComponentRole.REAGENT, rdecomp.getRoles()[2]);
		Assert.assertEquals("AuxInfo 2", "", rdecomp.getAuxInfos()[2]);
		Assert.assertEquals("Inchi 3", "InChI=1S//", rdecomp.getIinchis()[3]);
		Assert.assertEquals("Role 3", ReactionComponentRole.REAGENT, rdecomp.getRoles()[3]);
		Assert.assertEquals("AuxInfo 3", "", rdecomp.getAuxInfos()[3]);
		Assert.assertEquals("Inchi 4", "InChI=1S/C4H8O/c1-3-4(2)5-3/h3-4H,1-2H3/t3-,4?/m0/s1", rdecomp.getIinchis()[4]);
		Assert.assertEquals("Role 4", ReactionComponentRole.PRODUCT, rdecomp.getRoles()[4]);
		Assert.assertEquals("AuxInfo 4", "", rdecomp.getAuxInfos()[4]);
	}
	...
	public void test_08() throws Exception {
		...
		Assert.assertEquals("RInChIDecomposition", RinchiDecompositionStatus.SUCCESS, rdecomp.getStatus());
		Assert.assertNotNull("Inchis: ", rdecomp.getIinchis());
		Assert.assertEquals("Number of inchis: ", 6, rdecomp.getIinchis().length);
		Assert.assertEquals("RInChI reaction direction: ", ReactionDirection.BACKWARD, rdecomp.getReactionDirection());
		...
		Assert.assertEquals("Inchi 2", "InChI=1S/C4H8O/c1-3-4(2)5-3/h3-4H,1-2H3/t3-,4-/m0/s1", rdecomp.getIinchis()[2]);
		Assert.assertEquals("Role 2", ReactionComponentRole.PRODUCT, rdecomp.getRoles()[2]);
		Assert.assertEquals("AuxInfo 2", "AuxInfo=1/0/N:3,5,2,1,4/E:(1,2)(3,4)/it:im/rA:5nCCCOC/rB:s1;P2;s1s2;N1;/rC:3.8966,-.151,0;4.7216,-.151,0;5.4361,-.5635,0;4.3091,.5635,0;3.1822,-.5635,0;", rdecomp.getAuxInfos()[2]);
		Assert.assertEquals("Inchi 3", "InChI=1S/ClH.Na/h1H;/q;+1/p-1", rdecomp.getIinchis()[3]);
		Assert.assertEquals("Role 3", ReactionComponentRole.AGENT, rdecomp.getRoles()[3]);
		Assert.assertEquals("AuxInfo 3", "AuxInfo=1/1/N:2;1/rA:2nNa+Cl-/rB:;/rC:.4571,-.5804,0;-.3679,-.5804,0;", rdecomp.getAuxInfos()[3]);
		Assert.assertEquals("Inchi 4", "InChI=1S/ClH/h1H", rdecomp.getIinchis()[4]);
		Assert.assertEquals("Role 4", ReactionComponentRole.AGENT, rdecomp.getRoles()[4]);
		Assert.assertEquals("AuxInfo 4", "AuxInfo=1/0/N:1/rA:2nClH/rB:s1;/rC:.7482,-.5134,0;1.5732,-.5134,0;", rdecomp.getAuxInfos()[4]);
		Assert.assertEquals("Inchi 5", "InChI=1S/H2O/h1H2", rdecomp.getIinchis()[5]);
		Assert.assertEquals("Role 5", ReactionComponentRole.AGENT, rdecomp.getRoles()[5]);
		Assert.assertEquals("AuxInfo 5", "AuxInfo=1/0/N:2/rA:3nHOH/rB:s1;s2;/rC:-.2457,.3313,0;.4688,.7438,0;1.1832,.3313,0;", rdecomp.getAuxInfos()[5]);
	}
	...
	public void test_09() throws Exception {
		...
		Assert.assertEquals("RInChIDecomposition", RinchiDecompositionStatus.SUCCESS, rdecomp.getStatus());
		Assert.assertNotNull("Inchis: ", rdecomp.getIinchis());
		Assert.assertEquals("Number of inchis: ", 2, rdecomp.getIinchis().length);
		Assert.assertEquals("RInChI reaction direction: ", ReactionDirection.BACKWARD, rdecomp.getReactionDirection());

		Assert.assertEquals("Inchi 0", "InChI=1S/C5H12O/c1-4(2)5(3)6/h4-6H,1-3H3", rdecomp.getIinchis()[0]);
		Assert.assertEquals("Role 0", ReactionComponentRole.REAGENT, rdecomp.getRoles()[0]);
		Assert.assertEquals("AuxInfo 0", "AuxInfo=1/0/N:1,3,5,2,4,6/E:(1,2)/rA:6nCCCCCO/rB:s1;s2;s2;s4;s4;/rC:5.2741,1.4438,0;5.9886,1.8563,0;6.703,1.4438,0;5.9886,2.6813,0;6.703,3.0938,0;5.2741,3.0938,0;", rdecomp.getAuxInfos()[0]);
		Assert.assertEquals("Inchi 1", "InChI=1S/C8H8O2/c9-8(10)6-7-4-2-1-3-5-7/h1-5H,6H2,(H,9,10)", rdecomp.getIinchis()[1]);
		Assert.assertEquals("Role 1", ReactionComponentRole.REAGENT, rdecomp.getRoles()[1]);
		Assert.assertEquals("AuxInfo 1", "AuxInfo=1/1/N:3,2,4,1,5,7,6,8,9,10/E:(2,3)(4,5)(9,10)/rA:10nCCCCCCCCOO/rB:d1;s2;d3;s4;s1d5;s6;s7;s8;d8;/rC:-3.8009,2.917,0;-4.5154,2.5045,0;-4.5154,1.6795,0;-3.8009,1.2669,0;-3.0864,1.6795,0;-3.0864,2.5045,0;-2.372,2.917,0;-1.6575,2.5045,0;-.943,2.917,0;-1.6575,1.6795,0;", rdecomp.getAuxInfos()[1]);
	}
