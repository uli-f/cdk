...
public class RInChIGenerator {
    ...
    protected final RinchiOptions options;
    protected final IReaction reaction;
    protected RinchiOutput rinchiOutput;
    protected RinchiKeyOutput shortRinchiKeyOutput;
    protected RinchiKeyOutput longRinchiKeyOutput;
    protected RinchiKeyOutput webRinchiKeyOutput;
    protected final List<String> rinchiInputGenerationErrors = new ArrayList<>();
